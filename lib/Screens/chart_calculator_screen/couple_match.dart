...
class CoupleMatchScreen extends StatefulWidget {
  const CoupleMatchScreen({super.key});

  @override
  State<CoupleMatchScreen> createState() => _CoupleMatchScreenState();
}
  
class _CoupleMatchScreenState extends State<CoupleMatchScreen> {
  @override
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                Get.offAll(BottomNavTabs(initialIndex: 1));
                                              },
