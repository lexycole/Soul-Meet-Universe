...
import 'package:soul_meet_num/Screens/terms_and_policy.dart';
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: ListTile(
              leading: ClipRRect(
                borderRadius: BorderRadius.circular(15.0),
                child: Icon(Icons.text_snippet, size: 40,color: Colors.grey[900]),
              ),
              title: Text('Terms & Policy', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
              onTap: () {
